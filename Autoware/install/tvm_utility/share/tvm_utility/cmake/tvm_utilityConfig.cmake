...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tvm_utility' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/autoware/Autoware/install/tvm_utility/lib;/home/autoware/Autoware/install/autoware_msgs/lib;/home/autoware/Autoware/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
