...
if(sensor_config_edit_CONFIG_INCLUDED)
  return()
endif()
set(sensor_config_edit_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(sensor_config_edit_SOURCE_PREFIX /home/autoware/AIFI_ws/src/sensor_config_edit)
  set(sensor_config_edit_DEVEL_PREFIX /home/autoware/AIFI_ws/devel)
  set(sensor_config_edit_INSTALL_PREFIX "")
  set(sensor_config_edit_PREFIX ${sensor_config_edit_DEVEL_PREFIX})
else()
  set(sensor_config_edit_SOURCE_PREFIX "")
  set(sensor_config_edit_DEVEL_PREFIX "")
  set(sensor_config_edit_INSTALL_PREFIX /home/autoware/AIFI_ws/install)
  set(sensor_config_edit_PREFIX ${sensor_config_edit_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'sensor_config_edit' is deprecated")
...
set(sensor_config_edit_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(sensor_config_edit_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${sensor_config_edit_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sensor_config_edit' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'sensor_config_edit' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/autoware/AIFI_ws/src/sensor_config_edit/${idir}'.  ${_report}")
    endif()
    _list_append_unique(sensor_config_edit_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND sensor_config_edit_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND sensor_config_edit_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT sensor_config_edit_NUM_DUMMY_TARGETS)
      set(sensor_config_edit_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::sensor_config_edit::wrapped-linker-option${sensor_config_edit_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR sensor_config_edit_NUM_DUMMY_TARGETS "${sensor_config_edit_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::sensor_config_edit::wrapped-linker-option${sensor_config_edit_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND sensor_config_edit_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(sensor_config_edit_LIBRARY_DIRS ${lib_path})
      list(APPEND sensor_config_edit_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'sensor_config_edit'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND sensor_config_edit_LIBRARIES ${lib})
    endif()
  endif()
...
set(sensor_config_edit_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${sensor_config_edit_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 sensor_config_edit_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${sensor_config_edit_dep}_FOUND)
      find_package(${sensor_config_edit_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${sensor_config_edit_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(sensor_config_edit_INCLUDE_DIRS ${${sensor_config_edit_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(sensor_config_edit_LIBRARIES ${sensor_config_edit_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${sensor_config_edit_dep}_LIBRARIES})
  _list_append_deduplicate(sensor_config_edit_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(sensor_config_edit_LIBRARIES ${sensor_config_edit_LIBRARIES})

  _list_append_unique(sensor_config_edit_LIBRARY_DIRS ${${sensor_config_edit_dep}_LIBRARY_DIRS})
  list(APPEND sensor_config_edit_EXPORTED_TARGETS ${${sensor_config_edit_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${sensor_config_edit_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
